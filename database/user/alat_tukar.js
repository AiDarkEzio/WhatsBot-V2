...
const file4 = path.join(__dirname, "inventory.json");
let _inventoryOrang = JSON.parse(fs.readFileSync(file4));
...
const addInventori = (sender) => {
  ...
  fs.writeFileSync(file4, JSON.stringify(_inventoryOrang));
};
